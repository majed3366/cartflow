# -*- coding: utf-8 -*-
"""
Commercial Guidance Foundation V1 — production/demo validation helper.
...
def main() -> int:
    ...
    report = {
        "ok": bool(
            ...
            and body.get("consumes_guidance_eligibility_only") is True
            and body.get("registry_valid") is True
            and body.get("one_current_per_subject") is True
            and int(body.get("guidance_count") or 0) > 0
