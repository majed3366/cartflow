# -*- coding: utf-8 -*-
"""
Knowledge Foundation V1 — production/demo validation helper.
...
def main() -> int:
    ...
    url = (
        f"{base}/dev/knowledge-foundation"
    ...
    report = {
        "ok": bool(
            ...
            and body.get("inputs_evidence_confidence_only") is True
            and body.get("all_statements_reference_confidence") is True
            and int(body.get("statement_count") or 0) > 0
