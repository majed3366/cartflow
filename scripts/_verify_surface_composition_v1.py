# -*- coding: utf-8 -*-
"""
Surface Composition Foundation V1 — production/demo validation helper.
...
def main() -> int:
    ...
    url = (
        f"{base}/dev/surface-composition"
    ...
    report = {
        "ok": bool(
            ...
            and body.get("consumes_governed_inputs_only") is True
            and body.get("accounting_ok") is True
            and body.get("registries_valid") is True
            and int(body.get("duplicate_current") or 0) == 0
            and int(body.get("composition_count") or 0) > 0
