...
|-------------|--------------------|-----------------|
| `#page-carts` work queue (`renderPeV2CartsQueue` / MI groups after Gate 3 strip) | `GET /api/dashboard/normal-carts` → `merchant_carts_page_rows` | `#cf2-carts-root` queue list |
...
| VIP threshold form | Settings ownership (Gate 3) | Not rendered on Carts |
