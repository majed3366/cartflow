# -*- coding: utf-8 -*-
"""Founder evidence — Products V1.2. Local R17, 390px, 6 shots. DEPLOY: NO."""
...
DESKTOP = Path(r"C:\Users\Toshiba\Desktop\CartFlow_Founder_Review\Products_V1_2")

SHOTS = [
    "products_v1_2_top_mobile.png",
    "products_v1_2_truth_rich_cards_mobile.png",
    "products_v1_2_mixed_truth_mobile.png",
    "products_v1_2_truth_limited_mobile.png",
    "products_v1_2_identity_degraded_mobile.png",
    "products_v1_2_full_density_mobile.png",
]
...
def main() -> int:
    ...
    db_path = os.path.join(
        tempfile.gettempdir(),
        "cartflow_products_v1_2_%s.db" % os.getpid(),
    )
    ...
    env["SECRET_KEY"] = "products-v1-2-founder-review"
  ...
  if (window.CartFlowUiV2 && window.CartFlowUiV2.go) {
    window.CartFlowUiV2.go('products');
            ...
            into('[data-cf2-prd-id="nf-rose-damascus"]', "start")
            snap(SHOTS[2])
