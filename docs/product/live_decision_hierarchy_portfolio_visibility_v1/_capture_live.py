...
DESKTOP = Path(
    r"C:\Users\Toshiba\Desktop\CartFlow_Founder_Review\Live_Decision_Hierarchy_Portfolio_Visibility_V1"
)
...
SHOTS = [
    "01_home_now_and_monitoring_mobile.png",
    "02_home_price_non_competing_mobile.png",
    "03_workspace_hierarchy_mobile.png",
    "04_workspace_single_mission_flow_mobile.png",
    "05_decision_sidebar_states_mobile.png",
    "06_workspace_no_state_contradiction_mobile.png",
]
...
def main() -> int:
    ...
    with sync_playwright() as p:
        ...
        snap(SHOTS[0])
        page.locator("[data-cf2-ldh-group='monitoring']").first.scroll_into_view_if_needed()
        ...
        snap(SHOTS[2])
        page.locator("[data-cf2-ldh-flow='execution']").first.scroll_into_view_if_needed()
        page.wait_for_timeout(400)
        snap(SHOTS[3])
        ...
        page.locator("[data-cf2-ldh-flow='decision']").first.scroll_into_view_if_needed()
        page.wait_for_timeout(400)
        snap(SHOTS[5])
        browser.close()
    return 0
