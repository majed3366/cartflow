...
(function () {
  ...
  function getPersuasionMessage(reason) {
    ...
    if (reason === "thinking" || reason === "hesitation") {
      return (
        "إذا كنت متردد 🤔\n" +
        "خلني أساعدك تختار الخيار الأنسب لك بدون تعقيد\n" +
        "وعندك أكثر من خيار تقدر تقارن بينهم بكل راحة 👇"
      );
    }
    if (reason === "warranty") {
      return (
        "اطمّن 🙏\n" +
        "المنتج عليه ضمان وتقدر تسترجعه إذا ما كان مناسب لك\n" +
        "هدفنا إنك تكون مرتاح 100% قبل ما تكمل الطلب 👇"
      );
    }
