    ...
    try:
        ...
        ops = {
            ...
            "presentation_v11": {
                "intervention_stores": [],
                "monitoring_stores": [],
                "actionable_platform_alerts": [],
                "monitoring_platform_alerts": [],
                ...
                "presentation_generated_at_utc": None,
                "presentation_generated_at_ar": "",
                "generated_at_utc": None,
                "generated_at_ar": "",
                "evidence_freshness_utc": None,
                "evidence_freshness_source": None,
                "evidence_freshness_missing_sources": [
                    "store_action_center",
                    "critical_alerts",
                    "recovery_resume_health",
                ],
                "production_store_count": None,
                "production_affected_count": None,
            },
        }
    return templates.TemplateResponse(
        request,
