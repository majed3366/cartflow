    ...
    *,
    ...
    if _needs_intervention(
        ...
        return _finish(
            ...
            what_next="أوقف CartFlow المسار الآلي مؤقتاً بانتظار إزالة العائق أو اكتمال البيانات.",
            merchant_needed="نعم",
            dashboard_action="archive",
        ),
    ...
    if (
        ...
        return _finish(
            ...
            what_next=f"تمت جدولة الرسالة — {eta}",
            merchant_needed="لا",
            dashboard_action="archive",
    ...
    if sent_proven and not replied and not exhausted:
        return _finish(
            ...
            what_next="بانتظار تفاعل العميل.",
            merchant_needed="لا",
            dashboard_action="archive",
        ),
    ...
    if pre_send_without_send and not schedule_materialized:
        ...
        if phone_blocked:
            return _finish(
                _pack(
                    ...
                    what_next="لا توجد وسيلة تواصل متاحة حالياً — سيبدأ التواصل تلقائياً عند توفر بيانات التواصل.",
                    merchant_needed="نعم",
                    dashboard_action="archive",
        ...
        return _finish(
            _pack(
                ...
                what_next="بانتظار اكتمال بيانات السلة — سيتابع CartFlow تلقائياً عند الجاهزية.",
                merchant_needed="لا",
                dashboard_action="archive",
