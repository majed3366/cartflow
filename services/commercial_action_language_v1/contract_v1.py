...
def contract_for_family_v1(
    ...
    *,
    ...
    if kind == FAMILY_SHIPPING:
        ...
        return {
            "situation_ar": "أقوى تردد مسجّل الآن يقع عند خطوة الشحن.",
            "evidence_ar": evidence_ar,
            "diagnosis_ar": (
                "لا يتضح بعد هل العملاء يتوقفون بسبب تكلفة الشحن أم بسبب مدة التوصيل."
            ),
            "action_ar": (
                "اجعل أسباب التردد التي يختارها العميل عند الشحن تفرّق بوضوح بين "
                "«تكلفة الشحن مرتفعة» و«مدة التوصيل طويلة» — حتى نعرف أيّهما يوقف الشراء."
            ),
            "dont_ar": (
