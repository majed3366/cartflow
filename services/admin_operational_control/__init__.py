...
def build_admin_operational_control_readonly() -> dict[str, Any]:
    ...
    try:
        ...
        mixed_behavior_line_ar = get_latest_mixed_behavior_load_test_display_ar()
    except Exception:
        mixed_behavior_line_ar = MIXED_BEHAVIOR_LOAD_TEST_DISPLAY_UNAVAILABLE_AR

    failure_simulation_line_ar = None
    try:
        ...
        failure_simulation_line_ar = get_latest_failure_simulation_display_ar()
    except Exception:
    ...
    return {
        ...
        "latest_mixed_behavior_load_test_ar": mixed_behavior_line_ar,
        "latest_failure_simulation_ar": failure_simulation_line_ar,
